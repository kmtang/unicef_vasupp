...
c1 <- data %>% dplyr::select(caseid, v001, v005, b8_01, h34_1, h9_1)
c2 <- data %>% dplyr::select(caseid, v001, v005, b8_02, h34_2, h9_2)
c3 <- data %>% dplyr::select(caseid, v001, v005, b8_03, h34_3, h9_3)
c4 <- data %>% dplyr::select(caseid, v001, v005, b8_04, h34_4, h9_4)
c5 <- data %>% dplyr::select(caseid, v001, v005, b8_05, h34_5, h9_5)
c6 <- data %>% dplyr::select(caseid, v001, v005, b8_06, h34_6, h9_6)

names(c1) <- c('caseid',"cluster", "weight",'age', 'vas', "mea")
names(c2) <- c('caseid',"cluster", "weight",'age', 'vas', "mea")
names(c3) <- c('caseid',"cluster", "weight",'age', 'vas', "mea")
names(c4) <- c('caseid',"cluster", "weight",'age', 'vas', "mea")
names(c5) <- c('caseid',"cluster", "weight",'age', 'vas', "mea")
names(c6) <- c('caseid',"cluster", "weight",'age', 'vas', "mea")
...
ggplot(vas_cov) + 
  geom_pointrange(aes(x = reorder(country, order), y = vasupp, ymin = vasupp_low, ymax = vasupp_upp, color = mea_cat))+ 
  theme_bw() +
...
order <- vas_cov %>% filter(mea_cat=="yes") %>% arrange(vasupp) %>% select(country) %>% dplyr::mutate(order = row_number())
vas_cov<- merge(x=vas_cov, y=order, by.x='country', by.y='country', fill=-9999, all.x = TRUE)

write.csv(vas_cov, "/Users/kevintang/Library/Mobile Documents/com~apple~CloudDocs/Documents/r_projects/unicef_vasupp/data/vas_mea.csv", row.names=FALSE)

vas_cov <- read.csv("/Users/kevintang/Library/Mobile Documents/com~apple~CloudDocs/Documents/r_projects/unicef_vasupp/data/vas_mea.csv")
```
...
c1 <- data %>% dplyr::select(caseid, v001, v005, b8_01, b19_01, h34_1, h9_1)
c2 <- data %>% dplyr::select(caseid, v001, v005, b8_02, b19_02, h34_2, h9_2)
c3 <- data %>% dplyr::select(caseid, v001, v005, b8_03, b19_03, h34_3, h9_3)
c4 <- data %>% dplyr::select(caseid, v001, v005, b8_04, b19_04, h34_4, h9_4)
c5 <- data %>% dplyr::select(caseid, v001, v005, b8_05, b19_05, h34_5, h9_5)
c6 <- data %>% dplyr::select(caseid, v001, v005, b8_06, b19_06, h34_6, h9_6)

names(c1) <- c('caseid', "cluster", "weight", 'age', 'age_m', 'vas', "mea")
names(c2) <- c('caseid', "cluster", "weight", 'age', 'age_m', 'vas', "mea")
names(c3) <- c('caseid', "cluster", "weight", 'age', 'age_m', 'vas', "mea")
names(c4) <- c('caseid', "cluster", "weight", 'age', 'age_m', 'vas', "mea")
names(c5) <- c('caseid', "cluster", "weight", 'age', 'age_m', 'vas', "mea")
names(c6) <- c('caseid', "cluster", "weight", 'age', 'age_m', 'vas', "mea")
